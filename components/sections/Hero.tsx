...
const Hero: React.FC = () => {
  return (
    <section
      className="pt-32 pb-16 md:pt-40 md:pb-12 px-4 md:px-6 container mx-auto"
      id="home"
    >
      <div className="grid grid-cols-1 md:grid-cols-12 gap-4 md:gap-6 auto-rows-auto">
        ...
        {/* 3. Stats - Experience */}
        <Card className="md:col-span-4 bg-primary text-black flex flex-col justify-center items-center text-center">
          <span className="font-display font-bold text-5xl md:text-6xl mb-2">
            {PERSONAL_INFO.yearsExperience}
          </span>
          <span className="text-secondary font-medium">Years Experience</span>
        </Card>
        ...
        <Card className="md:col-span-4 bg-primary text-black flex flex-col justify-center items-center text-center">
          ...
          <span className="text-secondary font-medium">Projects Completed</span>
        </Card>
        ...
        <Card className="md:col-span-4 flex flex-col justify-center items-center text-center border-2 border-dashed border-gray-200 shadow-none">
          <span className="font-display font-bold text-5xl md:text-6xl mb-2 text-primary">
            {PERSONAL_INFO.technologiesMastered}
          </span>
